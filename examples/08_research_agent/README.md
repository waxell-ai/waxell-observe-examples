...
Deep research pipeline with query classification, document retrieval, web search, 3-step reasoning chain, and answer synthesis.
...
# With real API calls
python examples/08_research_agent/research_agent.py

# Custom query
python examples/08_research_agent/research_agent.py --dry-run --query "Your question here"

# Trigger policy enforcement (intentionally exceed limits)
python examples/08_research_agent/research_agent.py --policy-triggers
```
