...
Multi-step RAG pipeline with document retrieval, relevance filtering, and answer synthesis using OpenAI auto-instrumentation.
...
# With real API calls
python examples/02_rag_agent/rag_agent.py

# Custom query
python examples/02_rag_agent/rag_agent.py --dry-run --query "Your question here"

# Trigger policy enforcement (intentionally exceed limits)
python examples/02_rag_agent/rag_agent.py --policy-triggers
```
