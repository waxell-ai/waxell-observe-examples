...
Full support pipeline: intent classification, order lookup, inventory check, decision tree, retry/fallback handling, and confidence routing.
...
# With real API calls
python examples/07_support_agent/support_agent.py

# Custom query
python examples/07_support_agent/support_agent.py --dry-run --query "Your question here"

# Trigger policy enforcement (intentionally exceed limits)
python examples/07_support_agent/support_agent.py --policy-triggers
```
