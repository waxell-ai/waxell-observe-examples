...
4-phase governance showcase: pre-execution policy spans, mid-execution check_policy(), retry feedback loop with sync wrappers, and event recording.
...
# With real API calls
python examples/04_governance_agent/governance_agent.py

# Custom query
python examples/04_governance_agent/governance_agent.py --dry-run --query "Your question here"

# Trigger policy enforcement (intentionally exceed limits)
python examples/04_governance_agent/governance_agent.py --policy-triggers
```
